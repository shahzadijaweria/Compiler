#if you were able to run this code (when your compiler is finished) you will get 1 bonus marks
#1) The list initialization at line 8

#This code can be used to test lexer
